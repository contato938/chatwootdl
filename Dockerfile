...
# Use bash for subsequent RUN commands to support pipefail
...
RUN apk update && apk add --no-cache bash build-base musl ruby-full ruby-dev gcc make musl-dev openssl openssl-dev g++ linux-headers xz vips
